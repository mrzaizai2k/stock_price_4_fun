...
if not TELEBOT_API:
    print('TELEBOT_API not specified in .env file, please set TELEBOT_API with your bot token generated by @BotFather')
    exit(1)
...
def toggle_button_state(button_text):
